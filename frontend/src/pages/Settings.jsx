...
// ==========================================
// SimpleScreen — shared layout with back arrow
// ==========================================
const SimpleScreen = ({ title, onBack, children }) => (
  <div className="d-flex flex-column h-100">
    ...
    >
      ...
      <h1 className="fw-bold m-0 ms-3" style={{ fontSize: "24px" }}>
        {title}
      </h1>
    </div>
    <div className="p-3 flex-grow-1 overflow-auto">{children}</div>
  </div>
);
        ...
        {options.map((lang, idx) => (
          <div
            ...
            style={{
              cursor: "pointer",
              backgroundColor:
                selected === lang ? "rgba(0,51,204,0.05)" : "transparent",
              borderBottom:
          ...
          >
            <p className="m-0 flex-grow-1 fw-bold" style={{ fontSize: "16px" }}>
              {lang}
            </p>
            {selected === lang && (
              <span style={{ color: "#0033CC", fontWeight: "bold" }}>✓</span>
            )}
          </div>
        ))}
      </div>
        ...
        {options.map((unit, idx) => (
          <div
            ...
            style={{
              cursor: "pointer",
              backgroundColor:
                selected === unit ? "rgba(0,51,204,0.05)" : "transparent",
              borderBottom:
                idx === options.length - 1
                  ? "none"
                  : "1px solid rgba(0,0,0,0.1)",
...
// ==========================================
// CHANGE PASSWORD — Coming Soon (Option B)
// ==========================================
const ChangePasswordScreen = ({ onBack }) => (
  <SimpleScreen title="Change Password" onBack={onBack}>
    <div className="text-center py-5">
      <span style={{ fontSize: "48px" }}>🔒</span>
      <p className="fw-bold mt-3 mb-1" style={{ fontSize: "16px" }}>
        Coming soon
      </p>
      <p className="text-secondary mb-4" style={{ fontSize: "14px" }}>
        To reset your password, use the "Forgot Password" option on the sign-in
        screen.
      </p>
      <button
        className="btn fw-bold py-3 px-4 text-white"
        style={{
...
// PRIVACY SCREEN
// ==========================================
const PrivacyScreen = ({ onBack, onViewFullPolicy }) => {
    ...
    <SimpleScreen title="Privacy" onBack={onBack}>
      <div className="d-flex align-items-center p-3 border rounded-3 mb-3">
        <div className="flex-grow-1">
          ...
          <p className="m-0 text-secondary" style={{ fontSize: "12px" }}>
            Allow us to use anonymous data to improve features
          </p>
        </div>
      ...
      >
        ...
        <p className="mb-2" style={{ fontSize: "13px", lineHeight: 1.5 }}>
          MyCare treats your medication and symptom information as sensitive
          health data. We apply encryption in transit and at rest, and use
          role-based access controls for dependent profiles.
        </p>
        <p className="mb-2" style={{ fontSize: "13px", lineHeight: 1.5 }}>
          <strong>We do not sell your health information.</strong> We only
          share data with third-party service providers where necessary to
          deliver the service (Firebase for notifications, AWS/Google Cloud
          for hosting, Paystack for payments).
        </p>
        <p className="mb-2" style={{ fontSize: "13px", lineHeight: 1.5 }}>
        ...
        <p className="m-0" style={{ fontSize: "13px", lineHeight: 1.5 }}>
      ...
      <p className="text-secondary" style={{ fontSize: "12px" }}>
        For full details, please review our Terms & Conditions and Privacy
        Policy.
      </p>
    </SimpleScreen>
  );
      ...
      <div className="border rounded-3 overflow-hidden mb-4">
        <div className="p-3 border-bottom">
          ...
          <p className="m-0" style={{ fontSize: "15px" }}>
            MyCare is a mobile health platform designed to help individuals and
            caregivers manage medications, track symptoms, and stay organized.
          </p>
        </div>
        ...
        <div className="p-3 border-bottom d-flex justify-content-between">
          ...
          <span style={{ fontSize: "15px" }}>
            BeTechiFied May 2026 Consortium
          </span>
        </div>
        ...
        <div className="p-3 d-flex justify-content-between">
          ...
          <span style={{ fontSize: "15px", color: "#0033CC" }}>
            info@mycare-consortium.com
          </span>
        </div>
      </div>
...
const BiometricScreen = ({ onBack }) => {
  ...
  return (
    <SimpleScreen title="Biometric & Passcode" onBack={onBack}>
      ...
      <p className="text-secondary mt-3" style={{ fontSize: "13px" }}>
        For added security, we recommend keeping Biometrics enabled.
      </p>
    ...
    <SimpleScreen title="App Version" onBack={onBack}>
      ...
      <div className="border rounded-3 overflow-hidden">
        <div className="p-3 border-bottom d-flex justify-content-between">
          ...
          <span style={{ color: "#4CBB17", fontWeight: "bold" }}>
            Up to date
          </span>
        </div>
        <div className="p-3 border-bottom d-flex justify-content-between">
...
const Settings = () => {
  ...
  if (currentScreen === "language")
    return <LanguageScreen onBack={() => setCurrentScreen("menu")} />;
  if (currentScreen === "units")
    return <UnitsScreen onBack={() => setCurrentScreen("menu")} />;
  if (currentScreen === "password")
    return <ChangePasswordScreen onBack={() => setCurrentScreen("menu")} />;
  if (currentScreen === "privacy")
    return (
      <PrivacyScreen
        onBack={() => setCurrentScreen("menu")}
        onViewFullPolicy={() => setCurrentScreen("privacy-policy")}
      />
    );
  if (currentScreen === "privacy-policy")
    return <PrivacyPolicy />;
  if (currentScreen === "about")
    return <AboutScreen onBack={() => setCurrentScreen("menu")} />;
  if (currentScreen === "biometric")
    return <BiometricScreen onBack={() => setCurrentScreen("menu")} />;
  if (currentScreen === "version")
    return <AppVersionScreen onBack={() => setCurrentScreen("menu")} />;
  if (currentScreen === "reminders")
    return <Reminders onBack={() => setCurrentScreen("menu")} />;
  if (currentScreen === "help")
    return <HelpSupport onBack={() => setCurrentScreen("menu")} />;
  ...
  return (
    <div className="d-flex flex-column h-100">
      ...
      <div className="overflow-auto px-3 py-3">
        {/* PREFERENCES */}
        <p
          className="text-secondary fw-bold mb-2 mt-3"
          style={{ fontSize: "20px" }}
        >
          Preferences
        </p>
        ...
        <div className="border rounded-3 overflow-hidden mb-4">
          ...
          <div
            className="d-flex align-items-center p-3"
            style={{ ...rowStyle, borderBottom: "none" }}
            onClick={() => setCurrentScreen("version")}
          >
            <InfoCircle size={24} />
            <div className="flex-grow-1 ms-3">
              <p className="m-0 fw-bold" style={{ fontSize: "16px" }}>
