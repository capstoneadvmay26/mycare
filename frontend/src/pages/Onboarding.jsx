...
const Onboarding = () => {
  ...
  const handleVerifyOTP = async () => {
    ...
    try {
      const identifier = method === 'Phone' ? phone : email;
      const response = await verifyOtp(method.toLowerCase(), identifier, otpString);
  ...
  return (
    ...
    >
      ...
      {error && (
        <div className="alert alert-danger py-2 mb-2" style={{ fontSize: '14px' }}>
          {error}
        </div>
      )}
      {successMessage && (
        <div className="alert alert-success py-2 mb-2" style={{ fontSize: '14px' }}>
          {successMessage}
        </div>
      )}
      ...
      {step === 'signup' && (
        <>
          ...
          <div className="my-auto py-3">
            {/* Phone / Email Tabs */}
            <div
              className="d-flex border rounded-3 overflow-hidden mb-4"
              style={{ height: '50px', border: '1px solid rgba(0,0,0,0.2)', borderRadius: '8px' }}
            >
              <button
          ...
          <div>
            <div className="text-center mb-3">
              ...
              <p
                ...
                style={{ fontSize: '13px', color: '#0033CC', cursor: 'pointer' }}
              >
                Terms & Privacy Policy
              </p>
            </div>
            <div className="d-flex align-items-center mb-2">
              <div className="flex-grow-1 border-top" style={{ borderColor: 'rgba(0,0,0,0.2)' }} />
              <span className="px-3 text-center text-dark" style={{ fontSize: '14px' }}>
                Already have an account?{' '}
                <span className="fw-bold" style={{ color: '#0033CC', cursor: 'pointer' }}>
                  Log in
                </span>
              </span>
              <div className="flex-grow-1 border-top" style={{ borderColor: 'rgba(0,0,0,0.2)' }} />
          ...
          <div className="my-auto py-2 w-100">
            ...
            {canResend ? (
              <p
                ...
                style={{ color: '#0033CC', fontSize: '16px', cursor: 'pointer' }}
        ...
        <>
          ...
          <div>
            ...
            <p className="mb-3 text-secondary" style={{ fontSize: '14px' }}>
              This information helps us to personalize your experience and provide better care.
            </p>
          </div>
                  ...
                  >
                    {gender === g && (
                      <div
                        ...
                        style={{ width: '10px', height: '10px', backgroundColor: '#0033CC' }}
                      />
                    )}
                  </div>
                  {g}
